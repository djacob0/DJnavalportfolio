  ...
  <div name="home" className="w-full h-screen bg-[#0000CD]">
    <div className="max-w-[1000px] mx-auto px-8 flex flex-col sm:flex-row justify-between items-center h-full">
      <div className="sm:w-1/2 text-center sm:text-left">
        ...
        <h1 className="text-4xl sm:text-6xl font-bold text-gray-300 leading-tight">
          Daniel Jacob Naval,
        </h1>
        <h2 className="text-2xl sm:text-5xl font-bold text-gray-300 pt-2 leading-tight">
          Glad to see you!
        </h2>
        <p className="text-gray-300 py-4 text-sm sm:text-base max-w-[700px] group-hover:text-blue-500 transition-all duration-500">
          ...
          website tailored to your needs. My strong debugging skills allow me
          to identify and resolve issues efficiently, helping to maintain a smooth user experience.
        </p>
